...
public class XmppContentProvider extends ContentProvider {
    ...
    public static void add_message(XmppMessage xm) {
        ...
        values.put("main", xm.main);
        values.put("name", xm.user.name);
        values.put("username", xm.user.userName);
        values.put("too", xm.to);
        values.put("type", xm.type);
        values.put("content", xm.content);
        values.put("time", xm.time);
        values.put("result", xm.result);
