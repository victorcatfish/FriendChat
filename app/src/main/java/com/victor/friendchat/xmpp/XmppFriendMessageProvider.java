...
public class XmppFriendMessageProvider extends ContentProvider {
    ...
    public static void add_message(XmppChat xc) {
        ...
        values.put("main", xc.main);
        values.put("user", xc.user);
        values.put("nickname", xc.nickname);
        values.put("icon", xc.icon);
        values.put("type", xc.type);
        values.put("content", xc.content);
        values.put("sex", xc.sex);
        values.put("too", xc.too);
        values.put("sex", xc.sex);
        values.put("viewtype", xc.viewType);
        values.put("time", xc.time);
